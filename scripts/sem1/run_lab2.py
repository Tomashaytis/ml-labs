...
from src.classifiers.bayesian import Bayesian, Minimax, NeymanPearson
from src.utils.sem1.lab2 import estimate_sample_volume, complex_plot
...
if __name__ == '__main__':
    ...
    if CLASSIFIER == 'bayesian':
        classifier_bc = Bayesian([sample1.params, sample2.params], IS_EQUAL_COVARIANCE)
        ...
        classifier_mc = Minimax(sample1.params, sample2.params, IS_EQUAL_COVARIANCE)
        ...
        classifier_npc = NeymanPearson(sample1.params, sample2.params, MAX_ERROR_PROB, IS_EQUAL_COVARIANCE)
    ...
    classifier_bc = Bayesian([sample1.params, sample2.params, sample3.params])
    classifier_bc.plot(main_sample, main_labels)
    classifier_bc.plot_with_lines(main_sample, COLORS, main_labels)
    print('Bayesian errors')
    print('real')
