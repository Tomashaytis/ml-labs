...
from src.classifiers.svm import SVM, KernelSVM
from src.utils.sem1.lab2 import complex_plot
from src.utils.sem1.lab3 import classifiers_stats
from src.utils.sem1.lab4 import complex_plot_linear, complex_plot_kernel
...
if __name__ == '__main__':
    ...
    if CLASSIFIER == 'svm':
        classifier_svm = SVM(sample1.params, sample2.params)
    ...
    if CLASSIFIER == 'svm':
        classifier_svm = SVM(sample0.params, sample1.params, C=C)
        classifier_svm.fit(main_sample, main_labels)
        classifier_svm.plot(main_sample, main_labels)
        classifier_svm.plot_with_lines(main_sample, COLORS, main_labels)
        ...
        classifier_svm1 = SVM(sample0.params, sample1.params, C=1 / 10)
        classifier_svm1.fit(main_sample, main_labels)
        classifier_svm2 = SVM(sample0.params, sample1.params, C=1)
        classifier_svm2.fit(main_sample, main_labels)
        classifier_svm3 = SVM(sample0.params, sample1.params, C=10)
        classifier_svm3.fit(main_sample, main_labels)
        classifier_svm_best = SVM(sample0.params, sample1.params, C=C)
    ...
    # Ядра
    if CLASSIFIER == 'svm':
        classifier_svm = KernelSVM(sample0.params, sample1.params, C=C, kernel=KERNEL)
        classifier_svm.fit(main_sample, main_labels)
        classifier_svm.plot(main_sample, main_labels)
